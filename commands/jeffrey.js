...
exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
    ...
    if (!userObj) {
        message.reply(`Wooo! You're not even in the Jeffrey database! You aren't close to becoming a Jeffrey.`);
    } else {
        ...
        const responseEmbed = new MessageEmbed()
            ...
            .setTimestamp()
            .setAuthor(`Jeffrey-fier :D`, 'https://yt3.ggpht.com/E0JWTeCC-h9UMNFojHIKHblClsQM_B6oQtpXXOVggkIt6MngkWoJ-G27i2O78CFlqkKitfUan3o=s88-c-k-c0x00ffffff-no-rj', 'https://www.youtube.com/c/Hamza97')
            .setFooter(`Written and maintained by Deleted User 0fd476ef#4008`);
        const jeffreyStats = await message.channel.send({ embeds: [responseEmbed] });
